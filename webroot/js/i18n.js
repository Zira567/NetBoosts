...
const STRINGS = {
  es: {
    ...
    toastTcpPartial: "Preset {{name}}: aplicado parcialmente ({{count}} parámetro(s) no soportado(s))",
  ...
  en: {
    ...
    toastTcpPartial: "{{name}} preset: partially applied ({{count}} parameter(s) unsupported)",
